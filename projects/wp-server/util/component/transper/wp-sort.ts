import { COM_SORT_ATT } from "../../../wp-type/WP_COM_ATT";
 ...
 * @example
  * ```ts
    ...
    * ```
 */
export class WpSortData extends WpComponentProperty {
    public o:Array<COM_SORT_ATT>;
    constructor(p_data:Array<COM_SORT_ATT>){
        super('/job', p_data, 'transform', 'sort');
    }
