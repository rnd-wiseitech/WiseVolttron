...
class gradientboostclassifier(WiseClassArgorithm) :
    ...
    def onEvaluating(self, p_dataSet:WiseDataSet, p_class, p_modelname):
        return super().onEvaluating(p_dataSet, p_class, p_modelname)
