...
@Component({
    selector: 'wp-lib-dx-scatter-chart',
    templateUrl: './wp-lib-dx-scatter-chart.component.html',
    styleUrls: ['./wp-lib-dx-scatter-chart.component.css']
})
export class WpDxScatterChartComponent implements OnInit, AfterViewInit, OnChanges {
    @Input() chartData: any;
    @Input() targetId: any;
